...
(
    ...
    prompt1 int constraint prompt1_id_fk references prompts(id) ON DELETE CASCADE,
    prompt2 int constraint prompt2_id_fk references prompts(id) ON DELETE CASCADE,
    prompt3 int constraint prompt3_id_fk references prompts(id) ON DELETE CASCADE
);
